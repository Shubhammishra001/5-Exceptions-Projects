...
public class ImageGalleryController {
	...
	private final org.jboss.logging.Logger log = LoggerFactory.logger(this.getClass());
	...
	String show(Model map) {
		java.util.List<ImageGallery> images = imageGalleryService.getAllActiveImages();
